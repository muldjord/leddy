...
NOTE! All sprites in the PNG and GIF files should match the resolution of your LED matrix (eg. 16x16 or 64x32). Leddy will scale them if needed, but the results will vary. It's better to scale them manually before adding them to get the result you want.
